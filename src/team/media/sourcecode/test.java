...
public class test {
    public static void main(String[] args) throws Exception{
        ...
        try
        {
            br = new BufferedReader(new FileReader("src/hw2/4Cat-Train.labeled"));
            btest = new BufferedReader(new FileReader("src/hw2/4Cat-Dev.labeled"));
        }
        catch(Exception e)
        {
            e.printStackTrace();
        ...
        while((row=br.readLine())!=null)
        {
            ...
            if(!row.equals("\n"))
            {
                ...
                if(Attributes[1].equals("Young"))
                    temp=1;
                else
                    temp=0;
                input=temp;
                if(Attributes[3].equals("3"))
                    temp=1;
                else
                    temp=0;
                input=input*2+temp;
                if(Attributes[5].equals("Southampton"))
                    temp= 1;
                else
                    temp=0;
                input=(input*2)+temp;
                if(Attributes[7].equals("Male"))
                    temp= 1;
                else
                    temp=0;
                input=input*2+temp;
